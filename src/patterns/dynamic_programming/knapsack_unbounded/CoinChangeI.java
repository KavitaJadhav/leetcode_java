...
public class CoinChangeI {
    ...
    public static void main(String[] args) {
        CoinChangeI coinChange = new CoinChangeI();
        System.out.println(coinChange.coinChange(new int[]{2,5,3}, 5));;
        System.out.println(coinChange.coinChange(new int[]{2,5,3,1}, 6));;
    }
}