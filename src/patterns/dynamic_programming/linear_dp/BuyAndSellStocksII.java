...
public int maxProfit(final List<Integer> prices) {
    ...
    public static void main(String[] args) {
        System.out.println(new BuyAndSellStocksII().maxProfit(new ArrayList<>(Arrays.asList(5,2,10))));
        System.out.println(new BuyAndSellStocksII().maxProfit(new ArrayList<>(Arrays.asList(7, 1, 5, 3, 6, 4))));
    }
}
//[5, 2, 10]
//hold -5,-2, -2
