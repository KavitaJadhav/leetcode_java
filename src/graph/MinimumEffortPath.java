...
//Treat the grid as a graph where edge weight is the height difference.
//Use Dijkstra’s algorithm with a min-heap, where the path cost is the maximum edge weight seen so far.
